...
assert.equal(
  ...
  "Bună ziua, atașat fișa de intervenție nr. 2026-0142 din data 25.09.2026. Mulțumim! — UTILAJE PRO SRL"
);
assert.equal(
  clientMessage(emptyFisa({ ...base, contentLocale: "en" }), settings),
  "Hello, please find attached service job sheet no. 2026-0142 dated 25/09/2026. Thank you! — UTILAJE PRO SRL"
);
assert.equal(
  clientMessage(emptyFisa({ ...base, contentLocale: "pl" }), settings),
  "Dzień dobry, w załączniku protokół serwisowy nr 2026-0142 z dnia 25.09.2026. Dziękujemy! — UTILAJE PRO SRL"
);
