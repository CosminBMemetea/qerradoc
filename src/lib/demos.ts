...
function buildDemoCuratenieRo(technicianName?: string): Fisa {
  return emptyFisa({
    ...
    piese: fillPiese([
      { denumire: "Filtru HEPA circular", cod: "6.414-631.0", cantitate: "1", pretEur: "242.50" },
      { denumire: "Perie cilindrică standard 60 cm", cod: "4.762-450.0", cantitate: "1", pretEur: "445.00" },
      { denumire: "Garnitură etanșare rezervor murdar", cod: "5.035-488.0", cantitate: "1", pretEur: "81.00" },
      { denumire: "Curea transmisie perie", cod: "6.666-017.0", cantitate: "1", pretEur: "110.00" },
    ]),
...
function buildDemoTamplarieRo(technicianName?: string): Fisa {
  return emptyFisa({
    ...
    piese: fillPiese([
      { denumire: "Profil PVC Salamander 82 (ml)", cod: "SAL-82-W", cantitate: "38", pretEur: "62.00" },
      { denumire: "Sticlă termopan 4/16/4 Low-E Argon (m²)", cod: "GL-LE-4164", cantitate: "14.2", pretEur: "340.00" },
      { denumire: "Feronerie Maco Multi-Trend (set ferestre)", cod: "MACO-MT", cantitate: "4", pretEur: "475.00" },
      { denumire: "Feronerie Roto Patio (ușă glisantă)", cod: "ROTO-PAT", cantitate: "1", pretEur: "1400.00" },
      { denumire: "Prag aluminiu + garnituri + ancore", cod: "ACC-SET", cantitate: "1", pretEur: "725.00" },
    ]),
...
function buildDemoStomaRo(technicianName?: string): Fisa {
  return emptyFisa({
    ...
    piese: fillPiese([
      { denumire: "Anestezie articaină 4% + epinefrină (carpule)", cod: "ANEST-ART", cantitate: "2", pretEur: "40.00" },
      { denumire: "Material endodontic gutapercă + sealer (canal 26)", cod: "ENDO-26", cantitate: "1", pretEur: "275.00" },
      { denumire: "Reconstituire coronală compozit fotopolimerizabil", cod: "COMP-COR", cantitate: "1", pretEur: "225.00" },
      {
      ...
      { denumire: "Radiografie periapicală digitală", cod: "RX-PA", cantitate: "2", pretEur: "60.00" },
    ]),
